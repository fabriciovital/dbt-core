...
# Definição da DAG
with DAG(
    dag_id='ingest_delta_medium_tables',
    ...
    ingest_delta_medium_tables = run_container(
        task_id='ingest_delta_medium_tables',
        image='fabriciovital/data_engineering_stack:isp-performance',
        command="python /app/ingest_delta_medium_tables.py"
    )
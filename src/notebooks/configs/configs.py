...
SELECT 
    ...
    CAST(data_desistencia AS TIMESTAMP) AS data_desistencia,
    YEAR(data_desistencia) AS ano_desistencia,
    DATE_FORMAT(data_desistencia, 'yyyy-MM') AS ano_mes_desistencia,
    motivo_desistencia,
    obs_desistencia,
    obs_contrato,
    alerta_contrato,
    ...
    status_internet,
    id_cliente,
    CAST(data_assinatura AS TIMESTAMP) AS data_assinatura,
    YEAR(data_assinatura) AS ano_assinatura,
    DATE_FORMAT(data_assinatura, 'yyyy-MM') AS ano_mes_assinatura,
    CAST(data_ativacao AS TIMESTAMP) AS data_ativacao,
    YEAR(data_ativacao) AS ano_ativacao,
    DATE_FORMAT(data_ativacao, 'yyyy-MM') AS ano_mes_ativacao,
    CAST(data AS TIMESTAMP) AS data,
    YEAR(data) AS ano_data,
    DATE_FORMAT(data, 'yyyy-MM') AS ano_mes_data,
    CAST(data_renovacao AS TIMESTAMP) AS data_renovacao,
    YEAR(data_renovacao) AS ano_renovacao,
    DATE_FORMAT(data_renovacao, 'yyyy-MM') AS ano_mes_renovacao,
    bloqueio_automatico,
    imp_carteira,
    CAST(data_expiracao AS TIMESTAMP) AS data_expiracao,
    YEAR(data_expiracao) AS ano_expiracao,
    DATE_FORMAT(data_expiracao, 'yyyy-MM') AS ano_mes_expiracao,
    isentar_contrato,
    CAST(pago_ate_data AS TIMESTAMP) AS pago_ate_data,
    YEAR(pago_ate_data) AS ano_pago_ate_data,
    DATE_FORMAT(pago_ate_data, 'yyyy-MM') AS ano_mes_pago_ate_data,
    id_vd_contrato,
    contrato,
    endereco,
    numero,
    ...
    CAST(data_negativacao AS TIMESTAMP) AS data_negativacao,
    YEAR(data_negativacao) AS ano_negativacao,
    DATE_FORMAT(data_negativacao, 'yyyy-MM') AS ano_mes_negativacao,
    CAST(data_acesso_desativado AS TIMESTAMP) AS data_acesso_desativado,
    YEAR(data_acesso_desativado) AS ano_acesso_desativado,
    DATE_FORMAT(data_acesso_desativado, 'yyyy-MM') AS ano_mes_acesso_desativado,    
    motivo_cancelamento,
    CAST(data_cancelamento AS TIMESTAMP) AS data_cancelamento,
    YEAR(data_cancelamento) AS ano_cancelamento,
    DATE_FORMAT(data_cancelamento, 'yyyy-MM') AS ano_mes_cancelamento,
    obs_cancelamento,
    id_vendedor_ativ,
    fidelidade,
    tipo_cobranca,
